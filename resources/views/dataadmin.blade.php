          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Data / </span> Admin
              </h4>
                                  ...
                                  <div class="modal-body">
                                    <div class="row">
                                      ...
                                      <div class="col mb-3">
                                        ...
                                        <select class="form-select" id="exampleFormControlSelect1" name="Akses">
                    ...
                    <div class="text-nowrap">
                      <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                          ...
                          <tr>
                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$item->AdminID}}</strong></td>
                            <td>
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="{{url('aedit/'.$item->AdminID)}}"
                                    ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                  >
                                  <a class="dropdown-item" href="ahapus/{{$item->AdminID}}"
